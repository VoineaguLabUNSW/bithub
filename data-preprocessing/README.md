...
Rendered .html and .nb.html files are committed for transparency and ease of inspection.
...
# How to run the preprocessing
	...
	2.	Copy config/paths-example.yaml to config/paths.yaml and update paths.
